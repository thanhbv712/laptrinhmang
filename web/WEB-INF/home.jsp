...
<html>
    ...
    <body class="w3-theme-l5">
        ...
        <%
            ...
            ArrayList<User> listUser = (ArrayList<User>) request.getSession().getAttribute("listUser");
        ...
        <div class="w3-top">
            <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
                ...
                <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Ranking"><i class="fa fa-trophy"></i></a>
        ...
        <div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
            ...
            <div class="w3-row">
                ...
                <div class="w3-col m3" style="max-width:250px" >
                    ...
                    <div class="w3-card w3-round w3-white">
                        <div class="w3-container">
                            ...
                            <p class="w3-center"><img src="tuongbma.jpg" style="height:200px;width:200px" alt="Avatar"></p>
                            <hr>
                ...
                <div class="w3-col m6" style = "max-width: 650px">
                    ...
                    <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                        <img src="thanh.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
                    ...
                    <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                        <img src="hiep.jpg" alt="Avatar" class="w3-left w3-circle w3-margin-right" style="width:60px">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <tr>
                                                ...
                                                <c:if test="${u.getStatus() == 1}">
                                                    <td onclick="challenge(<c:out value="${user.getID()}"/>, <c:out value="${u.getID()}"/>)">
                                                        <button>OK</button>
                                                    </td>
                                                </c:if>
                                            </tr>
